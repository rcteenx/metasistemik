import { coachingPrograms } from "@/content/data/schools";

export default function CoachingProgramms({ id }) {
  return (
        ...
        <div className="mx-4 grid md:grid-cols-2 xl:grid-cols-5 gap-4 px-8 xl:px-0">
          {coachingPrograms.map((p) => (
            ...
            >
              <div
                className={
                  "px-4 py-8 xl:h-72 rounded-2xl shadow-custom2 flex flex-col items-center text-center border border-accent " +
