          ...
          <div className=" mx-auto bg-accent-light-3 p-4 md:p-12 text-accent-dark-7 rounded-xl my-8">
            ...
            <ul className="grid md:grid-cols-2 mx-auto gap-8 my-8 p-4 [&>li]:border [&>li]:bg-accent-light-7 [&>li]:rounded-xl [&>li]:p-4">
              ...
              <li>
                ...
                <p>
                  Bağlantısal bütünselliğe dayalı sistemik farkındalık
                  anlayışının benimsendiği, bilinçli ve sorumlu bireylerin ve
                  organizasyonların öncülüğünde daha adil, sürdürülebilir ve
                  refah dolu bir dünya inşa edilmesine hizmetlerimizle katkıda
                  bulunmak.
                </p>
              </li>
            </ul>
