  ...
  return (
    <section id="coaching-programms" className="mx-4">
      ...
      <div className="container mx-auto xl:-mt-[124px]">
        <div className="grid md:grid-cols-2 xl:grid-cols-5 gap-4 px-8 xl:px-0">
          ...
          <div className="services__item bg-accent-light-1 p-[30px] rounded-[10px] shadow-custom2 flex flex-col items-center text-center border-accent">
...
export default CoachingProgramms;
